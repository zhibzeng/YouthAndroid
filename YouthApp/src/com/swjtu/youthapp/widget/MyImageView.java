...
public class MyImageView extends ImageView {
	...
	private void arithScaleRate() {
		float scaleWidth = VisionPictureDetail.screenWidth / (float) imageWidth;
		float scaleHeight = VisionPictureDetail.screenHeight / (float) imageHeight;
	...
	public void setImageBitmap(Bitmap bitmap) {
		...
		arithScaleRate();
		//缩放到屏幕大小
		zoomTo(scaleRate,VisionPictureDetail.screenWidth / 2f, VisionPictureDetail.screenHeight / 2f);
...
//		RectF rect = new RectF(0, 0, imageWidth*getScale(), imageHeight*getScale());
	...
	public void layoutToCenter()
	{
		...
		//空白区域宽高
		float fill_width = VisionPictureDetail.screenWidth - width;
		float fill_height = VisionPictureDetail.screenHeight - height;
	...
	protected float getValue(Matrix matrix, int whichValue) {
		...
		mMinZoom =( VisionPictureDetail.screenWidth/2f)/imageWidth;
